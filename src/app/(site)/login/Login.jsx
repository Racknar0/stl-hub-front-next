                        ...
                        <div className="login-card">
                            ...
                            {!showGoogleLogin && (
                                <div className="form-info" style={{
                                    ...
                                    {isEn 
                                        ? 'Note: Google login is not supported inside social media browsers. Please log in with your email and password below.'
                                        : 'Nota: El inicio de sesión con Google no está disponible dentro del navegador de redes sociales. Por favor, accede con tu correo y contraseña abajo.'}
                                </div>
                            )}
